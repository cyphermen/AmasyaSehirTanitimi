...
public class Yufka_Tatlisi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yufka_tatlisi);
        ...
        HisdocumentReference.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    String Hiss = HisdocumentSnapshot.get("Yufka Tatlısı").toString();
        ...
        StorageReference Hispath = Hisreference.child("tatlilar/yufkatatlisi.png");

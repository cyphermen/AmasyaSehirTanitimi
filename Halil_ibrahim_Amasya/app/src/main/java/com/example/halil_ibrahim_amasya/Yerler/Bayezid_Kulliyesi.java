...
public class Bayezid_Kulliyesi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bayezid_kulliyesi);
        ...
        HisdocumentReference.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    String Hiss = HisdocumentSnapshot.get("külliye").toString();
        ...
        StorageReference Hispath = Hisreference.child("yerler/bayezid_kulliyesi.jpg");

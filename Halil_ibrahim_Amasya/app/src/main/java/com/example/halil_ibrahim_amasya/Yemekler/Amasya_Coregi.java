...
public class Amasya_Coregi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amasya_coregi);
        ...
        HisdocumentReference.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    String Hiss = HisdocumentSnapshot.get("Amasya_Çöreği").toString();
        ...
        StorageReference Hispath = Hisreference.child("yemekler/amasyacoregi.png");

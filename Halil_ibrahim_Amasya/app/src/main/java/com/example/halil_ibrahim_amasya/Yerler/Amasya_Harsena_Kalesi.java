...
public class Amasya_Harsena_Kalesi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amasya_harsena_kalesi);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (Hisdocument.exists()) {
                        HisBaslık.setText(HismenuArray.get(0));
                    }
                }
            }
        });
        ...
        HisdocumentReference.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    String Hiss = HisdocumentSnapshot.get("kale").toString();
        ...
        StorageReference Hispath = Hisreference.child("yerler/amasya_kalesi.jpg");

...
public class Bakla_Dolmasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bakla_dolmasi);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (Hisdocument.exists()) {
                        HisBaslık.setText(HismenuArray.get(2));
                    }
                }
            }
        });
        ...
        HisdocumentReference.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    String Hiss = HisdocumentSnapshot.get("Bakla Dolması").toString();
        ...
        StorageReference Hispath = Hisreference.child("/yemekler/amasyabakladolma.png");

...
public class Amasya_Saat_Kulesi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amasya_saat_kulesi);
        ...
        HisdocumentReference.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    String Hiss = HisdocumentSnapshot.get("Saat_Kulesi").toString();
        ...
        StorageReference Hispath = Hisreference.child("yerler/amasya_saat_kulesi.jpg");

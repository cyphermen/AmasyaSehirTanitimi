...
public class Ferhat_Su_Kanali extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ferhat_su_kanali);
        ...
        Hisreference2.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Map<String, Object> Hİsmenu = Hisdocument.getData();
                    ArrayList<String> menuArray = (ArrayList<String>) Hİsmenu.get("tarihiYerlerListe");
                    if (Hisdocument.exists()) {
                        HisBaslık.setText(menuArray.get(2));
                    }
                }
            }
        });
        ...
        HisdocumentReference.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    String Hiss = HisdocumentSnapshot.get("kanal").toString();
        ...
        StorageReference Hispath = Hisreference.child("yerler/ferhat_su_kanali.jpg");
